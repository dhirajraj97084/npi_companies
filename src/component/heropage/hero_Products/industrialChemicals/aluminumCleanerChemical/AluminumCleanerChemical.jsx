  ...
  return (
    ...
    <div className=" bg-white rounded-lg overflow-hidden mt-10">
      <div className="p-6 grid grid-cols-1 md:grid-cols-2">
       ...
       Aluminum Cleaner Chemical</h2>
        <p className="text-gray-600 mb-6">Home / Our Products / Industrial Chemical / Aluminum Cleaner Chemical</p>
        ...
        <div className="mt-6">
          ...
          We are successfully engaged in providing a wide gamut of Aluminum Cleaner Chemical.
          </p>
        </div>
       </div>
      </div>
...
export default  AluminumCleanerChemical;
