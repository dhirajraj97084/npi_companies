  ...
  return (
    <Layout>
      ...
      <div className=" mx-auto container  ">
        ...
        <div className="box1"><Link to={'/metalpretreatment'}><button className='p-4 rounded-md border-2 bg-orange-300 text-black border-black cursor-pointer'>A</button></Link></div>
        <div className="box2"><Link to={'/paintdetackification'}><button className='p-4 rounded-md border-2 hover:bg-orange-300 text-black border-black cursor-pointer'>B</button></Link></div>
