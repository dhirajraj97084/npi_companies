    ...
    <div className=" bg-white rounded-lg overflow-hidden mt-10">
      <div className="p-6 grid grid-cols-1 md:grid-cols-2">
        <div className="box1 img">
            <img className='w-full' src="https://jmindustry.in/wp-content/uploads/2022/09/images-5.jpg" alt="" />
        </div>
       <div className="box2 max-w-md mx-auto my-auto">
       <h2 className="text-xl font-bold text-gray-800 mb-4">
       Paint Stripper Chemical</h2>
        <p className="text-gray-600 mb-6">Home / Our Products / Industrial Chemical / Paint Stripper Chemical</p>
        ...
        <table className=" bg-white">
          <tbody>
            ...
            <tr className="border-b">
              <th className="text-left py-3 px-4 font-semibold text-gray-800">Form</th>
              <td className="py-3 px-4 text-gray-600">Liquid</td>
            </tr>
            <tr className="border-b">
              <th className="text-left py-3 px-4 font-semibold text-gray-800">Brand</th>
              <td className="py-3 px-4 text-gray-600">Chem Bond</td>
            </tr>
            <tr className="border-b">
              <th className="text-left py-3 px-4 font-semibold text-gray-800">Usage/Application</th>
              <td className="py-3 px-4 text-gray-600">Paint Remover</td>
            </tr>
            <tr className="border-b">
              <th className="text-left py-3 px-4 font-semibold text-gray-800">Country of Origin</th>
              <td className="py-3 px-4 text-gray-600">Made in India</td>
            </tr>
          </tbody>
        </table>
        ...
        <div className="mt-6">
          ...
          Backed with huge industry experience and market understanding, we are involved inproviding a wide variety of Oil Remover Chemical for our valued patrons.
          </p>
        </div>
       </div>
      </div>
