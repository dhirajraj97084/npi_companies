    ...
    <div className=" bg-white rounded-lg overflow-hidden mt-10">
      <div className="p-6 grid grid-cols-1 md:grid-cols-2">
        <div className="box1 img">
            <img className='w-full' src="https://jmindustry.in/wp-content/uploads/2022/09/Paint-Chemicals-300x300.jpg" alt="" />
        </div>
       <div className="box2 max-w-md mx-auto my-auto">
       <h2 className="text-xl font-bold text-gray-800 mb-4">
       Metal Pretreatment Chemical</h2>
        <p className="text-gray-600 mb-6">Home / Our Products / Industrial Chemical / Metal Pretreatment Chemical</p>
        ...
        <div className="mt-6">
          ...
          We are successfully meeting the requirements of our clients by offering the best quality range of Metal Pretreatment Chemical.
          </p>
        </div>
       </div>
      </div>
