    ...
    <div className=" bg-white rounded-lg overflow-hidden mt-10">
      <div className="p-6 grid grid-cols-1 md:grid-cols-2">
        <div className="box1 img">
            <img className='w-full' src="https://jmindustry.in/wp-content/uploads/2022/09/download-7.jpg" alt="" />
        </div>
       <div className="box2 max-w-md mx-auto my-auto">
       <h2 className="text-xl font-bold text-gray-800 mb-4">
       Ss Passivation Chemical</h2>
        <p className="text-gray-600 mb-6">Home / Our Products / Industrial Chemical / Ss Passivation Chemical</p>
        ...
        <div className="mt-6">
          ...
          Being a leading firm in this industry, we are offering a high quality range of SS Passivation Chemical.
          </p>
        </div>
       </div>
      </div>
