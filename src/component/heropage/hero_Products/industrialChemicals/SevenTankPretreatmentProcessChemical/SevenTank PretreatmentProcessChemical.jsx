 ...
 const   SevenTankPretreatmentProcessChemical = () => {
   return (
     <Layout>
     <div className=" bg-white rounded-lg overflow-hidden mt-10">
       <div className="p-6 grid grid-cols-1 md:grid-cols-2">
         <div className="box1 img">
             <img className='w-full' src="https://jmindustry.in/wp-content/uploads/2022/09/Best-Technology-Plating-Line-Tanks.jpg" alt="" />
         </div>
        <div className="box2 max-w-md mx-auto my-auto">
        <h2 className="text-xl font-bold text-gray-800 mb-4">
        7 Tank Pretreatment Process Chemical</h2>
         <p className="text-gray-600 mb-6">Home / 7 & 9 Tank Process Chemical / 7 Tank Pretreatment Process Chemical</p>
         ...
         <div className="mt-6">
           ...
           We are successfully engaged in providing a wide gamut of 7 Tank Pretreatment Process Chemical
           </p>
         </div>
        </div>
       </div>
 ...
 export default   SevenTankPretreatmentProcessChemical;
