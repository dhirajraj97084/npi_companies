...
function OtherChemicals() {
  return (
    <Layout>
       <div className="div  w-full ">
        <img
          className="w-full md:h-[35em]  h-[20em]"
          src="https://img.freepik.com/premium-photo/crashed-artificial-ice-rustic-metal-sheet_773922-56428.jpg?ga=GA1.1.672306854.1705143941&semt=ais_hybrid"
          alt=""
        />
      </div>
      ...
      <div className=" mx-auto container  ">
        ...
        <div className="box2"><Link to={'/paintdetackification'}><button className='p-4 rounded-md border-2 bg-orange-400 text-black border-black cursor-pointer'>B</button></Link></div>
