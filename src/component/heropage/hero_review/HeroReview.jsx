...
function HeroReview() {
    return (
     ...
     data-aos-offset="300"
     data-aos-easing="ease-in-sine" className="review_one bg-light-blue-800/60">
     ...
     data-aos-offset="300"
     data-aos-easing="ease-in-sine" className="review_two bg-light-blue-800/60">
                    ...
                    <div  data-aos="fade-right"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine" className="review_three bg-light-blue-800/60">
