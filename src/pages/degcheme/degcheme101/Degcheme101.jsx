   ...
   return (
     ...
     <div className=" bg-white rounded-lg overflow-hidden mt-10">
       <div className="p-6 grid grid-cols-1 md:grid-cols-2">
        ...
        DEGCHEME 101</h2>
         <p className="text-gray-600 mb-6">Home / Degreasing / DEGCHEME 101
         </p>
         ...
         <div className="mt-6">
           ...
           Neutral Cleaner, Mild Steam, Spray also an as Additive to DEGCHEME -HT
           </p>
         </div>
        </div>
       </div>
