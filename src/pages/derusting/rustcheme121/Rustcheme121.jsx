  ...
  return (
    <div className=" bg-white rounded-lg overflow-hidden mt-10">
      <div className="p-6 grid grid-cols-1 md:grid-cols-2">
       ...
       <h2 className="text-xl font-bold text-gray-800 mb-4">RUSTCHEME 121</h2>
        <p className="text-gray-600 mb-6">Home / Derusting / RUSTCHEME 121</p>
